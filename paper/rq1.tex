...
\subsection{Results}
Table~\ref{table:anova} shows that DFA size significantly affects the average matching accuracy for the regexes; this result is also seen in Table~\ref{table:anova2} where DFA size is shown to affect average composition.
...
\subsection{Summary}
Matching and composition are impacted by DFA size, and matching is also impacted by regex length and representation, showing some support that the size and representation of the regex impacts comprehension.
