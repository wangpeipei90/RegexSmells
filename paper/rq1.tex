...
\begin{table}[t]
\centering
\caption{3-factor ANOVA results with average matching/composition accuracy as the dependent variable, considering representation (rep), DFA size (dfa\_size), and regex length (len) as independent variables}
