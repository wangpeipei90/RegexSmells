...
These results also corroborate the refactorings suggested by match analysis for the LIT group (i.e., $\overrightarrow{T4 T1}$) and the LWB group (i.e., $\overrightarrow{L2 L3}$) because the more understandable node has the least unsures of its group. 
 The findings for D3 and D2 are contradictory, however, and further study is needed. 
