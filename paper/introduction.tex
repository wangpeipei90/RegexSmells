...
%why we need analysis despite of the tools
...
Section~\ref{sec:discussion} discusses implications and future work, followed by related work in Section~\ref{sec:related} and the conclusion in Section~\ref{sec:conclusion}.
