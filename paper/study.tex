...
In this work, we use the term {\em regex representation} to refer to the syntactic expression of a regular expression. A \emph{feature} is a structural component of a regular expression  (e.g., kleene star: \verb!*! or custom character class: \verb![1-5]!). An \emph{equivalence class} is a group of behaviorally equivalent regular expressions with different representations. 
