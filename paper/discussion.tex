...
It might be the case that, for example, among the default character classes in C4, there are significant differences (e.g., \verb![0-9]! may be preferred to \verb![\d]!, but \verb![A-Za-z0-9_]! may not be preferred to \verb![\w]!).
