...
We define equivalence class for various representations of regexes. 
Using an analysis of GitHub projects and understandability metrics from an empirical study with 180 participants, we identify canonical representations for regular expressions that conform to community standards and are the most understandable by programmers. 
For example, characters classes with ranges, such as \verb![0-9]!, were found to be more understandable than default shorthand representations, like \verb![\d]!. This provides evidence that a refactoring toward the range representation could improve regex understandability. This has implications for .... 
\end{abstract}
