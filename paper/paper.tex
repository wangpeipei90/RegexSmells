...
This work seeks to identify  code smells that impact comprehension. We conduct an empirical study on 42 of pairs of behaviorally equivalent but syntactically different regexes using 180 participants and evaluated the understandability of various regex language features. We found that some regex expression representations are more understandable than others. For example, our study showed that in expressing one or more repetitions of a character the plus (e.g., \verb!`a+'!) operator is more understandable than the kleene star operator (e.g., \verb!`aa*'!). We further analyzed regexes in GitHub to find the community standards, or the common usages of various features. Finally, we identified smelly and non-smelly regex representations based on a combination of community standards and understandability metrics. We also formed recommendations on how to transform regexes to enhance comprehension.
