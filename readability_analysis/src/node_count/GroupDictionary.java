...
public class GroupDictionary extends HashMap<String, NodeGroup> {
	...
	public void initializeNodeGroups() {
		...
		RnodeList.add(new RTNode(C.R1, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_OR)), dotStar));
		RnodeList.add(new RTNode(C.R2, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_OR)), dotStar));
