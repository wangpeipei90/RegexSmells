...
public class GroupDictionary extends HashMap<String, NodeGroup> {
	...
	public void initializeNodeGroups() {
		...
		DnodeList.add(new RTNode(C.D3, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_REP_QUESTIONABLE)), Pattern.compile(".*")));
		...
		RnodeList.add(new RTNode(C.R3, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_OR)), Pattern.compile(".*")));

		PnodeList.add(new RTNode(C.P1, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach()), Pattern.compile(".*")));
		PnodeList.add(new RTNode(C.P2, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_DOT_ANY,FeatureDictionary.I_XTRA_OPTIONS)), Pattern.compile(".*")));
		...
		PnodeList.add(new RTNode(C.P5, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_XTRA_OPTIONS,FeatureDictionary.I_META_LITERAL)), Pattern.compile(".*")));
		PnodeList.add(new RTNode(C.P6, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_LITERAL)), Pattern.compile(".*")));

		TnodeList.add(new RTNode(C.T1, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_LITERAL)), Pattern.compile(".*")));
		TnodeList.add(new RTNode(C.T2, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_LITERAL)), Pattern.compile(".*")));
		TnodeList.add(new RTNode(C.T3, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_LITERAL)), Pattern.compile(".*")));
		TnodeList.add(new RTNode(C.T4, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_LITERAL,FeatureDictionary.I_META_CC)), Pattern.compile(".*")));
		TnodeList.add(new RTNode(C.T5, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_LITERAL,FeatureDictionary.I_META_CC)), Pattern.compile(".*")));
		TnodeList.add(new RTNode(C.T6, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_LITERAL,FeatureDictionary.I_META_CC)), Pattern.compile(".*")));
		TnodeList.add(new RTNode(C.T7, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_LITERAL,FeatureDictionary.I_META_CC)), Pattern.compile(".*")));

		WnodeList.add(new RTNode(C.W1, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_POS_WORD)), Pattern.compile(".*")));
		WnodeList.add(new RTNode(C.W2, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach()), Pattern.compile(".*")));
		WnodeList.add(new RTNode(C.W3, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_POS_NONWORD)), Pattern.compile(".*")));
		WnodeList.add(new RTNode(C.W4, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach()), Pattern.compile(".*")));

		BnodeList.add(new RTNode(C.B1, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_META_NUMBERED_BACKREFERENCE)), Pattern.compile(".*")));
		BnodeList.add(new RTNode(C.B2, new FeatureSetClass(FeatureCountFactory.constructWithOneOfEach(FeatureDictionary.I_XTRA_NAMED_BACKREFERENCE,FeatureDictionary.I_XTRA_NAMED_GROUP_PYTHON)), Pattern.compile(".*")));
